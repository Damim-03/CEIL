    ...
    <div className="space-y-6">
        ...
        <div className="relative bg-white dark:bg-[#1A1A1A] rounded-2xl border border-[#D8CDC0]/60 dark:border-[#2A2A2A] p-5 overflow-hidden group hover:shadow-md hover:shadow-[#D8CDC0]/30 dark:hover:shadow-black/20 transition-all">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-[#1B1B1B] dark:text-[#E5E5E5]">{stats.active}</p>
            </div>
          </div>
        </div>
        <div className="relative bg-white dark:bg-[#1A1A1A] rounded-2xl border border-[#D8CDC0]/60 dark:border-[#2A2A2A] p-5 overflow-hidden group hover:shadow-md hover:shadow-[#D8CDC0]/30 dark:hover:shadow-black/20 transition-all">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-[#1B1B1B] dark:text-[#E5E5E5]">{stats.inactive}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-[#1A1A1A] rounded-2xl border border-[#D8CDC0]/60 dark:border-[#2A2A2A] p-5">
        ...
        <div className="mt-3 text-sm text-[#6B5D4F] dark:text-[#888888]">
          ...
          <span className="font-semibold text-[#1B1B1B] dark:text-[#E5E5E5]">{filteredStudents.length}</span>{" "}
          {t("admin.students.of")}{" "}
          <span className="font-semibold text-[#1B1B1B] dark:text-[#E5E5E5]">{students.length}</span>{" "}
                ...
                <div className="flex items-center gap-4 flex-1 min-w-0">
                  {student.user?.google_avatar ? (
                    <img
                      ...
                      className="w-14 h-14 rounded-full object-cover border-2 border-[#D8CDC0]/60 dark:border-[#2A2A2A] shadow-md shrink-0"
                    />
                  ) : (
                    <div className="w-14 h-14 rounded-full bg-gradient-to-br from-[#C4A035] to-[#C4A035]/70 flex items-center justify-center text-white text-xl font-semibold shadow-lg shadow-[#C4A035]/15 dark:shadow-[#C4A035]/10 shrink-0">
