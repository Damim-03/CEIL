    ...
    <div className="space-y-8 max-w-5xl mx-auto">
      ...
      >
        ...
        <div className="grid gap-5 md:grid-cols-3">
          <FieldGroup
            label={t("admin.courseProfile.language")}
            hint="اختر اللغة لضمان التجميع الصحيح في الصفحة العامة"
          >
            <select
              value={form.language}
              onChange={(e) => handleChange("language", e.target.value)}
              dir="ltr"
              className="w-full h-10 px-3 rounded-lg border border-input bg-background text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
            >
